...
const registerUser = asyncHandler( async (req, res) => {
    ...
    const user = await User.create({
        fullName,
        avatar: avatar.url,
        coverImage: coverImage?.url || "", //if coverimage is present then store its url and if not then send empty
        email,
        password,
...
const updateUserAvatar = asyncHandler(async(req, res) => {
    ...
    const avatarLocalPath = req.fild?.path
...
const updateUserCoverImage = asyncHandler(async(req, res) => {
    ...
    const coverImageLocalPath = req.fild?.path
